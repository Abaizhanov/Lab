...
bg = pygame.image.load('image/mic.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load("image/second.png")
left_rect = image_left.get_rect(bottomleft=(415, 565))
image_right = pygame.image.load('image/minute.png')
...
while True:
    ...
    right_rect1 = (
    right_rect[0] - right_hand_rot.get_rect().width / 2, right_rect[1] - right_hand_rot.get_rect().height / 2)
